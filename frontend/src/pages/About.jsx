        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <span className="inline-flex items-center space-x-2 bg-[#FA2931]/10 px-4 py-2 rounded-full mb-6 border border-[#FA2931]/20">
              <span className="text-sm text-[#FA2931] font-medium">Meet Our Experts</span>
            </span>
            <h2 className="text-3xl sm:text-4xl font-bold text-[#0E1833] mb-4">
              Our Team
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              A passionate team of healthcare innovators, clinicians, and technologists working together to transform kidney care
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group relative">
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#FA2931] to-[#d91f27] p-1">
                <div className="bg-white rounded-[22px] p-6 h-full">
                  <div className="relative mb-6">
                    <div className="w-32 h-32 mx-auto rounded-full bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                      <img 
                    ...
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-[#FA2931] text-white text-xs font-semibold px-3 py-1 rounded-full">
                      Founder
                    </div>
                  </div>
                  <div className="text-center">
                    <h3 className="text-xl font-bold text-[#0E1833] mb-1">Dr. Arun Kumar</h3>
                    <p className="text-[#FA2931] font-medium text-sm mb-3">CEO & Chief Nephrologist</p>
                    <p className="text-gray-600 text-sm leading-relaxed">
                      20+ years in nephrology. Former AIIMS faculty. Pioneer in digital kidney care solutions.
                    </p>
                  </div>
                  <div className="flex justify-center gap-3 mt-4">
                    <a href="#" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#FA2931] hover:text-white transition-colors">
            ...
            {/* Team Member 2 */}
            <div className="group relative">
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#3B82F6] to-[#1d4ed8] p-1">
                <div className="bg-white rounded-[22px] p-6 h-full">
                  <div className="relative mb-6">
                    <div className="w-32 h-32 mx-auto rounded-full bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                      <img 
                        src="https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=300&h=300&fit=crop&crop=face"
                        alt="Dr. Priya Sharma"
                        className="w-full h-full object-cover"
                      />
                    </div>
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-[#3B82F6] text-white text-xs font-semibold px-3 py-1 rounded-full">
                      Co-Founder
                    </div>
                  </div>
                  <div className="text-center">
                    <h3 className="text-xl font-bold text-[#0E1833] mb-1">Dr. Priya Sharma</h3>
                    <p className="text-[#3B82F6] font-medium text-sm mb-3">Chief Medical Officer</p>
                    <p className="text-gray-600 text-sm leading-relaxed">
                      Public health specialist. WHO consultant. Leading our clinical research initiatives.
                    </p>
                  </div>
                  <div className="flex justify-center gap-3 mt-4">
                    <a href="#" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#3B82F6] hover:text-white transition-colors">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                    </a>
                    <a href="#" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#3B82F6] hover:text-white transition-colors">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
            ...
            {/* Team Member 3 */}
            <div className="group relative">
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#10B981] to-[#059669] p-1">
                <div className="bg-white rounded-[22px] p-6 h-full">
                  <div className="relative mb-6">
                    <div className="w-32 h-32 mx-auto rounded-full bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                      <img 
                    ...
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-[#10B981] text-white text-xs font-semibold px-3 py-1 rounded-full">
                      Tech Lead
                    </div>
                  </div>
                  <div className="text-center">
                    <h3 className="text-xl font-bold text-[#0E1833] mb-1">Rahul Verma</h3>
                    <p className="text-[#10B981] font-medium text-sm mb-3">Chief Technology Officer</p>
                    <p className="text-gray-600 text-sm leading-relaxed">
                      15+ years in health-tech. Ex-Google engineer. Building scalable healthcare solutions.
                    </p>
                  </div>
                  <div className="flex justify-center gap-3 mt-4">
                    <a href="#" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#10B981] hover:text-white transition-colors">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                    </a>
                    <a href="#" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#10B981] hover:text-white transition-colors">
            ...
            {/* Team Member 4 */}
            <div className="group relative">
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#A855F7] to-[#7c3aed] p-1">
                <div className="bg-white rounded-[22px] p-6 h-full">
                  <div className="relative mb-6">
                    <div className="w-32 h-32 mx-auto rounded-full bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                      <img 
                    ...
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-[#A855F7] text-white text-xs font-semibold px-3 py-1 rounded-full">
                      Research
                    </div>
                  </div>
                  <div className="text-center">
                    <h3 className="text-xl font-bold text-[#0E1833] mb-1">Dr. Ananya Reddy</h3>
                    <p className="text-[#A855F7] font-medium text-sm mb-3">Head of Research</p>
                    <p className="text-gray-600 text-sm leading-relaxed">
                      PhD in Biomedical Engineering. Leading AI/ML initiatives for early CKD detection.
                    </p>
                  </div>
                  <div className="flex justify-center gap-3 mt-4">
                    <a href="#" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#A855F7] hover:text-white transition-colors">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                    </a>
                    <a href="#" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#A855F7] hover:text-white transition-colors">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-gradient-to-r from-[#0E1833] to-[#1a2847] rounded-2xl p-8 sm:p-6">
              <div className="text-center sm:text-left">
                <h3 className="text-xl font-bold text-white mb-1">Want to join our team?</h3>
                <p className="text-gray-300 text-sm">We're always looking for passionate people to join our mission.</p>
              </div>
              <Link to="/contact">
                <button className="px-6 py-3 bg-[#FA2931] text-white font-semibold rounded-full hover:bg-[#d91f27] transition-all duration-300 whitespace-nowrap">
                  View Open Positions
                </button>
              </Link>
            </div>
